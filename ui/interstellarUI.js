    ...
    instance.initialise = function() {
        ...
        instance.titleTemplate = Handlebars.compile(
            ['<tr><td colspan="2" style="border:none;">',
                '<h2 class="default btn-link" data-i18n="{{name}}">{{name}}</h2>',
                '<span>{{{desc}}}</span>',
                '<br><br>',
                '</td></tr>'].join('\n'));
        ...
        instance.militaryTitleTemplate = Handlebars.compile(
            ['<tr><td colspan="2" style="border:none;">',
                '<h2 class="default btn-link" data-i18n="{{name}}">{{name}}</h2>',
                '<h4><b data-i18n="Total Fleet Attributes:">Total Fleet Attributes:</b></h4>',
        ...
        instance.factionTitleTemplate = Handlebars.compile(
            ['<tr><td style="border:none; width:50%;">',
                '<h2 class="default btn-link" data-i18n="{{name}}">{{name}}</h2>',
                '<h4><b data-i18n="Relationship:">Relationship:</b> {{opinion}}</h4>',
                '<span>{{desc}}</span>',
                '<br><br>',
                '</td><td style="border:none; width:50%;">',
                '<br><br><br><h4><b data-i18n="Your Invasion Fleet:">Your Invasion Fleet:</b></h4>',
                '<h4><span class="fleetPower">0</span> <span data-i18n="Power">Power</span>,',
                '<span class="fleetDefense">0</span> <span data-i18n="Defense">Defense</span>,',
                '<span class="fleetSpeed">0</span> <span data-i18n="Speed">Speed</span></h4>',
                '</td></tr>'].join('\n'));

        instance.commMachineTemplate = Handlebars.compile(
            ['<tr id="{{htmlId}}"></tr><td>',
                '<h3 class="default btn-link" data-i18n="{{name}}">{{name}}: <span id="{{htmlId}}Count">0</span></h3>',
                '<span>',
                    '<p>{{desc}}</p>',
                    '<p id="{{htmlId}}_cost"></p>',
                '</span>',
                '<div id="{{htmlId}}_buy" onclick="Game.interstellar.comms.buildMachine(\'{{entryName}}\')" class="btn btn-default"><span data-i18n="Get">Get</span> {{name}}</div>',
                '</td></tr>'].join('\n'));
        ...
        instance.machineTemplate = Handlebars.compile(
            ['<tr id="{{htmlId}}"></tr><td>',
                ...
                '<span>',
                    ...
                    '<p id="{{htmlId}}_cost"></p>',
                '</span>',
                '<div id="{{htmlId}}_buy" onclick="Game.interstellar.antimatter.buildMachine(\'{{entryName}}\')" class="btn btn-default"><span data-i18n="Get">Get</span> 1</div>',
                '<div id="{{htmlId}}_destroy" onclick="Game.interstellar.antimatter.destroyMachine(\'{{entryName}}\')" class="btn btn-default"><span data-i18n="Destroy">Destroy</span> 1</div>',
                '</td></tr>'].join('\n'));

        instance.rocketTemplate = Handlebars.compile(
            ['<tr id="{{htmlId}}"></tr><td>',
                '<h3 class="default btn-link" data-i18n="{{name}}">{{name}}: <span id="{{htmlId}}Built"><span data-i18n="Not Built">Not Built</span></span></h3>',
                '<span>',
                    '<p>{{desc}}</p>',
                    '<p id="{{htmlId}}_cost"></p>',
                '</span>',
                '<div id="{{htmlId}}_buy" onclick="Game.interstellar.rocket.buildRocket(\'tier1Rocket\')" class="btn btn-default"><span data-i18n="Get">Get</span> {{name}}</div>',
                '</td></tr>'].join('\n'));

        instance.rocketPartTemplate = Handlebars.compile(
            ['<tr id="{{htmlId}}"><td>',
                '<h3 class="default btn-link" data-i18n="{{name}}">{{name}}: <span id="{{htmlId}}Count">0</span>/{{max}}</h3>',
                '<span>',
                    '<p>{{desc}}</p>',
                    '<p id="{{htmlId}}_cost"></p>',
                '</span>',
                '<div id="{{htmlId}}_buy" onclick="Game.interstellar.rocketParts.buildPart(\'{{entryName}}\', 1)" class="btn btn-default"><span data-i18n="Get">Get</span> {{name}}</div>',
                '<div id="{{htmlId}}_buy10" onclick="Game.interstellar.rocketParts.buildPart(\'{{entryName}}\', 10)" class="btn btn-default"><span data-i18n="Get">Get</span> 10</div>',
                '<div id="{{htmlId}}_buy{{max}}" onclick="Game.interstellar.rocketParts.buildPart(\'{{entryName}}\', {{max}})" class="btn btn-default"><span data-i18n="Get">Get</span> {{max}}</div>',
                '</td></tr>'].join('\n'));
        ...
        instance.starTemplate = Handlebars.compile(
            ['<tr id="{{htmlId}}" class="hidden"><td style="width:300px;">',
                ...
                '<h5>',
                    '<span data-i18n="Distance:">Distance:</span> {{distance}} (<span id="{{htmlId}}Cost">{{cost}}</span> <span data-i18n="Antimatter">Antimatter</span>)<br>',
                    '<span data-i18n="Planets:">Planets:</span> {{planets}}<br>',
                '</h5>',
                '<div class="btn btn-default" id="{{htmlId}}_explore" onclick="Game.interstellar.stars.exploreSystem(\'{{id}}\');"><span data-i18n="Explore">Explore</span></div>',
                '</td><td><br><br><br>',
                '<p>{{desc}}</p>',
                '</td></tr>'].join('\n'));
        ...
        instance.factionStarTemplate = Handlebars.compile(
            ['<tr id="{{htmlId}}_conquer" class="hidden"><td colspan="1">',
                '<h3 class="default btn-link" id="{{htmlId}}_name">{{name}}: <span id="{{htmlId}}_owned"><span data-i18n="Protected">Protected</span></span></h3>',
                '<h5>',
                    '<span data-i18n="Distance:">Distance:</span> {{distance}}<br>',
                    '<span data-i18n="Planets:">Planets:</span> {{planets}}<br>',
                    '<span data-i18n="Faction:">Faction:</span> {{faction}}<br>',
                    '<span data-i18n="Resources Present:">Resources Present:</span> {{resource1}}, {{resource2}}',
