var Game = (function() {
    ...
    // Preserve any existing Game properties (e.g. from i18n.js)
    var existingGame = window.Game || {};
    ...
    if (existingGame.lang) {
        instance.lang = existingGame.lang;
    }
    ...
    instance.save = function() {
        ...
        Game.notifyInfo(Game.lang.get('Game Saved'), Game.lang.get('Your save data has been stored in localStorage on your computer'));
    ...
    instance.loadDelay = function (self, delta) {
        ...
        if (typeof Game.lang !== 'undefined' && Game.lang.init) {
            Game.lang.init();
        }
    ...
    instance.notifyInfo = function(title, message) {
        ...
        if (typeof Game.lang !== 'undefined') {
            title = Game.lang.get(title);
            message = Game.lang.get(message);
        }
    ...
    instance.notifyStorage = function() {
        if(Game.settings.entries.notificationsEnabled === true){
            this.activeNotifications.storage = new PNotify({
                title: Game.lang.get("Storage Full!"),
                text: Game.lang.get('You will no longer collect resources when they are full.'),
                type: 'warning',
                animation: 'fade',
                animate_speed: 'fast',
                addclass: "stack-bottomright",
    ...
    instance.notifyOffline = function(time) {
        this.activeNotifications.success = new PNotify({
            title: Game.lang.get("Offline Gains"),
            text: Game.lang.get("You've been offline for ") + Game.utils.getFullTimeDisplay(time, true),
            type: 'info',
            animation: 'fade',
            animate_speed: 'fast',
            addclass: "stack-bottomright",
